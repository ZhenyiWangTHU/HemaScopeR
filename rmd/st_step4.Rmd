...
Differentially expressed genes are identified using [FindAllMarkers](https://satijalab.org/seurat/reference/findallmarkers) function. All markers found are stored in [this CSV file](../Step4_Find_DEGs/markers.csv). The first 5 markers of each cluster are shown below.
